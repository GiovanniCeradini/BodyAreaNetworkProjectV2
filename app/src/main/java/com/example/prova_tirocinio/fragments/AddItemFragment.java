 ...
 */
public class AddItemFragment extends Fragment implements ScannerFragmentListener,
    ...
    private static final String TAG="THINGY_ADD_FRAGMENT";

    //Occhiali
    private RelativeLayout glassLayout;
    private TextView glassName;
    private TextView glassAddress;
    private TextView glassOnOff;
    private ImageView glassImageIcon;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_add_thingy, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        glassLayout=view.findViewById((R.id.glasses_layout));
        glassName=view.findViewById(R.id.glass_name);
        glassAddress=view.findViewById(R.id.glass_address);
        glassOnOff=view.findViewById(R.id.glass_on_off);
        glassImageIcon=view.findViewById(R.id.glass_icon);
                    ...
                    public Unit invoke(BluetoothStatus status) {
                        ...
                        switch (status) {
                            case DISCONNECTED: {
                                ...
                                //AddItemFragment.this.setTextGlasse("disconnected");
                            }
                            break;
                            case CONNECTING: {
                                statusStr = "connecting...";

                                //AddItemFragment.this.setTextGlasse("connecting...");
                            }
                            break;
                            case CONNECTED: {
                                statusStr = "connected";
                                ...
                                //AddItemFragment.this.setTextGlasse("connected");
